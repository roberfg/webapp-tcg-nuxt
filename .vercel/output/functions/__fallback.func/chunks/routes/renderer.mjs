...
import { j as joinRelativeURL, b as useRuntimeConfig, e as getResponseStatusText, f as getResponseStatus, h as defineRenderHandler, a as getQuery, c as createError, i as destr, k as getRouteRules, l as joinURL, u as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/png","href":"/icon.png"}],"style":[],"script":[],"noscript":[],"title":"TCG collage"};
