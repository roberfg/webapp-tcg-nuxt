...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<h1 class="text-2xl font-bold">Database</h1></div><div class="bg-gray-800 rounded-xl p-8 text-center"><p class="text-gray-400">Próximamente...</p></div></div></div>`);
}
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/database.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const database = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { database as default };
//# sourceMappingURL=database-DPD664Pk.mjs.map
