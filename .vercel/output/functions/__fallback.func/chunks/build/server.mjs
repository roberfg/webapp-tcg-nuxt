...
import { m as parseURL, n as encodePath, o as decodePath, q as hasProtocol, r as isScriptProtocol, l as joinURL, w as withQuery, v as sanitizeStatusCode, x as getContext, $ as $fetch, c as createError$1, y as executeAsync, z as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "collage-magic",
    path: "/collage-magic",
    component: () => import('./collage-magic-Cv6lVwzV.mjs')
  },
  {
    name: "collage-pokemon",
    path: "/collage-pokemon",
    component: () => import('./collage-pokemon-ihlRjp2_.mjs')
  },
  {
    name: "collection",
    path: "/collection",
    component: () => import('./collection-DJD4b56o.mjs')
  },
  {
    name: "database",
    path: "/database",
    component: () => import('./database-DPD664Pk.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-a_530ko1.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CJpUTaT9.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-B6iNiM-A.mjs'));
