...
const translations = {
  es: {
    ...
    home_description: 'Genera collages visuales de tus cartas y mazos de forma rápida y bonita, para compartir con la comunidad.',
    ...
    footer_discord: 'Consultas',
    terms_title: 'Términos y Condiciones',
    terms_last_updated: 'Última actualización: abril 2025',
    terms_s1_title: '1. Uso del servicio',
    terms_s1: 'TCG Collage es una herramienta gratuita para generar collages de cartas de juegos de cartas coleccionables. Al usar este sitio, aceptas no utilizarlo para fines ilegales, comerciales no autorizados o que infrinjan derechos de terceros.',
    terms_s2_title: '2. Propiedad intelectual',
    terms_s2: 'Las imágenes de las cartas pertenecen a sus respectivos propietarios (Wizards of the Coast, The Pokémon Company, etc.). Este sitio no almacena ni redistribuye dichas imágenes; únicamente las consulta a través de APIs públicas para generar el collage en tu dispositivo.',
    terms_s3_title: '3. Exención de responsabilidad',
    terms_s3: 'El servicio se ofrece "tal cual", sin garantías de disponibilidad continua. No nos hacemos responsables de pérdidas de datos o perjuicios derivados del uso de la herramienta.',
    terms_s4_title: '4. Cambios en los términos',
    terms_s4: 'Nos reservamos el derecho de modificar estos términos en cualquier momento. Los cambios serán publicados en esta misma página.',
    terms_s5_title: '5. Contacto',
  ...
  en: {
    ...
    home_description: 'Quickly generate beautiful visual collages of your cards and decks to share with the community.',
    ...
    footer_discord: 'Support',
    terms_title: 'Terms & Conditions',
    terms_last_updated: 'Last updated: April 2025',
    terms_s1_title: '1. Use of service',
    terms_s1: 'TCG Collage is a free tool for generating collages of collectible card game cards. By using this site, you agree not to use it for illegal purposes, unauthorized commercial use, or in a way that infringes on third-party rights.',
    terms_s2_title: '2. Intellectual property',
    terms_s2: 'Card images belong to their respective owners (Wizards of the Coast, The Pokémon Company, etc.). This site does not store or redistribute those images; it only queries them through public APIs to generate the collage on your device.',
    terms_s3_title: '3. Disclaimer',
    terms_s3: 'The service is provided "as is", without guarantees of continuous availability. We are not responsible for any data loss or damages resulting from the use of this tool.',
    terms_s4_title: '4. Changes to terms',
    terms_s4: 'We reserve the right to modify these terms at any time. Changes will be published on this same page.',
    terms_s5_title: '5. Contact',
    terms_s5: 'For questions or inquiries, join our Discord server.',
  }
}
