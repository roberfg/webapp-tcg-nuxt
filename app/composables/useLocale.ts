...
const translations = {
  es: {
    ...
    help_magic_step3_desc: 'Haz clic en "Generar collage" para previsualizar el resultado y luego descárgalo como PNG.',
    ...
    help_pokemon_step3_desc: 'Genera el collage y descárgalo como imagen PNG lista para compartir.',
  ...
  en: {
    ...
    help_magic_step3_desc: 'Click "Generate collage" to preview the result, then download it as a PNG.',
