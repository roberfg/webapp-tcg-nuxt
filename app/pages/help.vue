...
<template>
  <div class="flex-1 p-4 sm:p-6">
    <div class="max-w-4xl mx-auto">
      ...
      <nav class="mb-8 pb-4 border-b border-brand-300 dark:border-brand-800">
        <ul class="space-y-2">
          <li v-for="section in gameSections" :key="section.id">
            ...
            >
              ...
              <span class="text-brand-400 dark:text-brand-600">→</span>
            </a>
          </li>
        </ul>
      </nav>
        ...
        >
          ...
          <div class="space-y-6">
            <div
              ...
              :key="index"
              class="    bg-brand-200 dark:bg-brand-900 rounded-xl overflow-hidden border border-brand-300 dark:border-brand-800"
            >
              <div class="p-5">
                <h3 class="font-semibold text-brand-950 dark:text-white mb-1">{{ step.title }}</h3>
                <p class="text-brand-500 dark:text-brand-400 text-sm">{{ step.desc }}</p>
              </div>
              <img
                :src="step.img"
                :alt="step.title"
